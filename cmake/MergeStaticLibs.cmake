...
#    Modified by (2015) Lucas Kahlert 
# 
...
# The build target will be suffixed with "-lib-static"
function(merge_static_libs outname)
  set(libs ${ARGV})
  list(REMOVE_AT libs 0)

  set(outlib "${outname}-lib-static")
  ...
  set_target_properties(${outlib} PROPERTIES
                                  OUTPUT_NAME "${outname}")
