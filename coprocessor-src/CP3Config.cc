...
// 
 ...
 opt_subsimp_vars(_cat, "cp3_susi_vars",     "variable limit to enable CP3", 5000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_subsimp_cls (_cat, "cp3_susi_cls",      "clause limit to enable CP3",   5000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_hte_vars    (_cat, "cp3_hte_vars",      "variable limit to enable CP3", 1000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_hte_cls     (_cat, "cp3_hte_cls",       "clause limit to enable CP3",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_bce_vars    (_cat, "cp3_bce_vars",      "variable limit to enable CP3", 3000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_bce_cls     (_cat, "cp3_bce_cls",       "clause limit to enable CP3",   10000000, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_la_vars     (_cat, "cp3_la_vars",        "clause limit to enable CP3",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_la_cls      (_cat, "cp3_la_cls",        "clause limit to enable CP3",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_cce_vars    (_cat, "cp3_cce_vars",      "variable limit to enable CP3", 5000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_cce_cls     (_cat, "cp3_cce_cls",       "clause limit to enable CP3",   30000000, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_rate_vars   (_cat, "cp3_rate_vars",     "variable limit to enable CP3", 1000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_rate_cls    (_cat, "cp3_rate_cls",      "clause limit to enable CP3",   2000000, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_ee_vars     (_cat, "cp3_ee_vars",       "variable limit to enable CP3", 5000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_ee_cls      (_cat, "cp3_ee_cls",        "clause limit to enable CP3",   20000000, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_bve_vars    (_cat, "cp3_bve_vars",      "variable limit to enable CP3", 5000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_bve_cls     (_cat, "cp3_bve_cls",       "clause limit to enable CP3",   20000000, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_bva_vars    (_cat, "cp3_bva_vars",      "variable limit to enable CP3", 3000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_bva_cls     (_cat, "cp3_bva_cls",       "clause limit to enable CP3",   20000000, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_Ibva_vars   (_cat, "cp3_Ibva_vars",     "variable limit to enable CP3", 1000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_Ibva_cls    (_cat, "cp3_Ibva_cls",      "clause limit to enable CP3",   10000000, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_Xbva_vars   (_cat, "cp3_Xbva_vars",     "variable limit to enable CP3", 1000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_Xbva_cls    (_cat, "cp3_Xbva_cls",      "clause limit to enable CP3",   5000000, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_unhide_vars (_cat, "cp3_unhide_vars",   "variable limit to enable CP3", 3000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_unhide_cls  (_cat, "cp3_unhide_cls",    "clause limit to enable CP3",   10000000, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_probe_vars  (_cat, "cp3_probe_vars",    "variable limit to enable CP3", 3000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_probe_cls   (_cat, "cp3_probe_cls",     "clause limit to enable CP3",   3000000, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_viv_vars    (_cat, "cp3_viv_vars",      "variable limit to enable CP3", 5000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_viv_cls     (_cat, "cp3_viv_cls",       "clause limit to enable CP3",   10000000, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_ternResolve_vars(_cat, "cp3_tRes_vars", "variable limit to enable CP3", 1000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_ternResolve_cls (_cat, "cp3_tRes_cls",  "clause limit to enable CP3",   20000000, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_symm_vars   (_cat, "cp3_symm_vars",     "variable limit to enable CP3", 3000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_symm_cls    (_cat, "cp3_symm_cls",      "clause limit to enable CP3",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_fm_vars     (_cat, "cp3_fm_vars",       "variable limit to enable CP3", 2000000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_fm_cls      (_cat, "cp3_fm_cls",        "clause limit to enable CP3",   10000000, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_xor_vars    (_cat, "cp3_xor_vars",      "variable limit to enable CP3", 700000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_xor_cls     (_cat, "cp3_xor_cls",       "clause limit to enable CP3",   3000000, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_sls_vars    (_cat, "cp3_sls_vars",      "variable limit to enable CP3", 500000, IntRange(0, INT32_MAX), optionListPtr ),
 opt_sls_cls     (_cat, "cp3_sls_cls",       "clause limit to enable CP3",   500000, IntRange(0, INT32_MAX), optionListPtr ), 
...
//
 ...
 opt_bve_verbose(0),
  ...
  opt_bve_strength    (_cat_bve, "bve_strength",  "do strengthening during bve", true, optionListPtr ),
   opt_bve_lits        (_cat_bve, "bve_red_lits",  "0=reduce number of literals, 1=reduce number of clauses,2=reduce any of the two,3 reduce both", 0, IntRange(0,3), optionListPtr ),
