...
// 
 ...
 opt_subsimp_lits(_cat, "cp3_susi_lits",     "total literal limit to enable subsimp",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_hte_lits(_cat, "cp3_hte_lits",          "total literal limit to enable HTE",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_bce_lits(_cat, "cp3_bce_lits",          "total literal limit to enable BCE,CLE,CLA",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_cce_lits(_cat, "cp3_cce_lits",          "total literal limit to enable CCE",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_rate_lits(_cat, "cp3_rate_lits",        "total literal limit to enable RATE",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_ee_lits(_cat, "cp3_ee_lits",            "total literal limit to enable EE",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_bve_lits(_cat, "cp3_bve_lits",          "total literal limit to enable BVE",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_bva_lits(_cat, "cp3_bva_lits",          "total literal limit to enable BVA",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_Ibva_lits(_cat, "cp3_Ibva_lits",        "total literal limit to enable IBVA",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_Xbva_lits(_cat, "cp3_Xbva_lits",        "total literal limit to enable XBVA",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_unhide_lits(_cat, "cp3_unhide_lits",    "total literal limit to enable UNHIDE",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_probe_lits(_cat, "cp3_probe_lits",      "total literal limit to enable PROBING",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_viv_lits(_cat, "cp3_viv_lits",          "total literal limit to enable VIVIFICATION",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_ternResolve_lits(_cat, "cp3_tRes_lits", "total literal limit to enable 3RES",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_symm_cls    (_cat, "cp3_symm_cls",      "clause limit to enable SYMM",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 opt_symm_lits(_cat, "cp3_symm_lits",        "total literal limit to enable SYMM",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_fm_lits(_cat, "cp3_fm_lits",            "total literal limit to enable FM",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_xor_lits(_cat, "cp3_xor_lits",          "total literal limit to enable XOR",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
 ...
 opt_sls_lits(_cat, "cp3_sls_lits",          "total literal limit to enable SLS",   INT32_MAX, IntRange(0, INT32_MAX), optionListPtr ), 
