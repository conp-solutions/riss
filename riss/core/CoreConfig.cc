...
CoreConfig::CoreConfig(const std::string& presetOptions)  // add new options here!
    ...
    opt_restart_ema_lbdfast     (_cr,"r-ema-lfast",              "Alpha for fast evolving EMA for interpretation size", 0.03125, DoubleRange(1, false, HUGE_VAL, false),                  optionListPtr, &opt_restarts_dyn_ema),
    opt_restart_ema_lbdslow     (_cr,"r-ema-lslow",              "Alpha for slow evolving EMA for interpretation size", 0.000061035156, DoubleRange(1, false, HUGE_VAL, false),           optionListPtr, &opt_restarts_dyn_ema),
