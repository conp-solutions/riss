...
namespace PcassoDebug {
    ...
    inline void PRINTLN(Riss::vec<Riss::Lit>& v) {
    ...
    inline void PRINTLN(Riss::vec<Riss::Lit>& v, unsigned int limit) {
        if (pcasso_debug_verbosity > 0) {
    ...
    inline void PRINTLN(Riss::Lit& l) {
        if (pcasso_debug_verbosity > 0) {
    ...
    inline void PRINTLN_DEBUG(Riss::Lit& l) {
        if (pcasso_debug_verbosity > 2) {
            std::cerr << (sign(l) ? "-" : "") << var(l) + 1 << " ";
            std::cerr << std::endl;
        }
    ...
    inline void PRINTLN_NOTE(Riss::Lit& l) {
        if (pcasso_debug_verbosity > 1) {
            std::cerr << (sign(l) ? "-" : "") << var(l) + 1 << " ";
            std::cerr << std::endl;
        }
