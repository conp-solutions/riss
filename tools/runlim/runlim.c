...
// to be able to create a pseudo terminal
#include <pty.h>
#include <utmp.h>
...
"    --output-file=<file>\n" \
"\n" \
"    -1 <file>                  overwrite or create <file> for saving the output of the binary (stdout)\n" \
"\n" \
"    -2 <file>                  overwrite or create <file> for saving the output of the binary (stderr)\n" \
"\n" \
...
main (int argc, char **argv)
{
  ...
  struct rlimit l;
  struct rlimit rl;
  const char *p, *out=NULL, *err=NULL;
  double real;
  time_t t;
