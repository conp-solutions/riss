...
#
./msTool $1 -method=CnfToWcnf -s -p > /tmp/shuffle_$$.cnf

if [ "x$2" != "x" ]
then
  cat /tmp/shuffle_$$.cnf
fi

cp bug.wcnf /tmp/shuffle_$$.cnf
...
timeout 10 ./mprocessor /tmp/shuffle_$$.cnf -dimacs=/tmp/msbva_$$.cnf -enabled_cp3 -cp3_stats  -probe -bve -bce -bva -bce-cle -ee -unhide -cce -hte -fm -xor
exitC2=$?
echo "exit2: $exitC2" 
