...
param="-cp3_Ibva=2 -enabled_cp3 -cp3_stats -bva"
#param="-enabled_cp3 -cp3_stats -cp3_verbose=1 -subsimp -bva -cp3_bva_ad=0 -bva-debug=0 -no-cp3_Xbva -cp3_Ibva"
#param="-enabled_cp3 -cp3_stats -3resolve -cp3_res_eagerSub"
#param="-enabled_cp3 -cp3_stats -unhide -bve -bva -ee -cce -hte -probe -subsimp -up -cp3_ee_level=3"
#param="-enabled_cp3 -cp3_stats -probe -unhide -bva -bve -ee -cce -hte -subsimp -up -dense"
#param=" -enabled_cp3 -probe -no-inprocess -no-pr-vivi"
#param="-enabled_cp3 -probe -cp3_unlimited"
#param="-enabled_cp3 -subsimp -naive_strength -bve -inprocess "
#param="-enabled_cp3 -bva -bve -ee -up -subsimp -unhide -probe -hte -cp3_bva_subOr -bve_gates -mem-lim=600 -inprocess -cp3_uhdNoShuffle"
...
# run the program
#
./minisat $1 /tmp/minisat-out_$$ $param > /dev/null 2> /dev/null

status=$?

cat /tmp/minisat-out_$$

rm -f /tmp/minisat-out_$$
