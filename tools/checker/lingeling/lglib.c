...
typedef struct Stats {
    ...
    struct {
        int count, skipped;
        struct { int count; int64_t sum; } kept;
    } restarts;
    ...
    struct {
        int64_t sat, mosat, simp, deref, fixed, freeze;
        int64_t melt, add, assume, cassume, failed, repr;
    } calls;
    struct {
        int vars;
    ...
    struct {
        int count, eq, units; int64_t esteps, csteps;
        struct { int all, and , xor, ite; } matched;
        struct { int all, and , xor, ite; } simplified;
        struct { int64_t all, and , xor, ite; } extracted;
    } cgr;
    struct {
    ...
    struct {
        ...
        int64_t resolutions, copies, subchks, strchks, ipos, steps;
    } elm;
    struct {
        struct { struct { int irr, red; } dyn; } sub, str;
        int driving, restarting;
    } otfs;
    ...
    struct {
        int64_t new, del, merged, col, gcs;
        struct { int64_t sum; int count; } deprior; int max;
    } queue;
    struct {
        int count, gcs, units, equivs, trneqs;
        struct { int max; int64_t sum; } arity;
        struct { int64_t extr, elim; } steps;
        int64_t extracted;
    } gauss;
    struct {
        int count, eliminated, ate, abce, failed, lifted;
