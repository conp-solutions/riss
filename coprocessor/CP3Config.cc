...
CP3Config::CP3Config(const std::string& presetOptions) // add new options here!
    ...
    pr_lcm_vivi       (_cat_pr, "pr-lcmC",        "Use vivifaction for clauses (1=plain vivi, 2=vivi+analyze, 3=vivi+unionanalyze, 4+reverse, >4 X-4, and-reverse)", 15, IntRange(0, 24), optionListPtr, &pr_lcm),
