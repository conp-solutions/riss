...
namespace Coprocessor {
    ...
    public:
        ...
        Riss::Lit fillHlaArrays(Riss::Var v, Coprocessor::BIG& big, Riss::MarkArray& hlaPositive, Riss::MarkArray& hlaNegative, Riss::Lit* litQueue,
                                bool doLock = false);
        ...
        bool hlaMarkClause(Riss::vec<Riss::Lit>& clause, Coprocessor::BIG& big, Riss::MarkArray& markArray, Riss::Lit* litQueue,
                           bool addLits = false);
        ...
        bool alaMarkClause(Riss::vec<Riss::Lit>& clause, Coprocessor::CoprocessorData& data, Riss::MarkArray& markArray, Riss::MarkArray& helpArray,
                           bool addLits = false);
    ...
    protected:
        ...
        void elimination_worker(CoprocessorData& data, uint32_t start, uint32_t end, BIG& big, bool doStatistics = true,
                                bool doLock = false); // subsume certain set of elements of the processing queue, does not write to the queue

        /** run hte for the specified variable */
        bool hiddenTautologyElimination(Riss::Var v, Coprocessor::CoprocessorData& data, Coprocessor::BIG& big, Riss::MarkArray& hlaPositive,
                                        Riss::MarkArray& hlaNegative, bool statistic = true, bool doLock = false);
