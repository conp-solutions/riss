...
namespace Coprocessor {
    ...
    class BlockedClauseElimination : public Technique<BlockedClauseElimination> {
        ...
        struct LitOrderBCEHeapLt { // sort according to number of occurrences of complement!
            ...
            LitOrderBCEHeapLt(CoprocessorData& _data, bool _useComplements)
                : data(_data)
        ...
        int bcm_cls, bcm_cls_cands,
            bcm_lits;           // number of clauses that have been affected by BCM, candidate clauses, literals that have been removed by BCM
    ...
    public:
        BlockedClauseElimination(CP3Config& _config, Riss::ClauseAllocator& _ca, Riss::ThreadController& _controller, CoprocessorData& _data,
