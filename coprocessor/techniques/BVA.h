...
namespace Coprocessor {
    ...
    class BoundedVariableAddition : public Technique<BoundedVariableAddition> {
        ...
        struct LitOrderBVAHeapLt {
            ...
            LitOrderBVAHeapLt(CoprocessorData& _data)
                : data(_data) {
            }
        };
    ...
    public:
        BoundedVariableAddition(Coprocessor::CP3Config& _config, Riss::ClauseAllocator& _ca, Riss::ThreadController& _controller,
                                Coprocessor::CoprocessorData& _data, Coprocessor::Propagation& _propagation);
    ...
    protected:
        ...
        struct xorHalfPair {
            Riss::Lit l1, l2;
            Riss::CRef c1, c2;
            xorHalfPair(Riss::Lit _l1, Riss::Lit _l2, Riss::CRef _c1, Riss::CRef _c2)
                : l1(_l1)
                , l2(_l2)
                , c1(_c1)
                , c2(_c2) {
        ...
        struct iteHalfPair {
            ...
            bool operator>(const iteHalfPair& other) const {
                const Riss::Var iv2 = var(l2);
                const Riss::Var jv2 = var(other.l2);
                const Riss::Var iv3 = var(l3);
                const Riss::Var jv3 = var(other.l3);
                const bool signDiff = (sign(l2));
                return (iv2 > jv2 || (iv2 == jv2 && iv3 > jv3) || (iv2 == jv2 && iv3 == jv3 && signDiff));
            }
            bool operator<(const iteHalfPair& other) const {
                return other > *this;
            }
