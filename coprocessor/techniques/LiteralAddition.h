...
namespace Coprocessor {
    ...
    class LiteralAddition : public Technique<LiteralAddition> {
        ...
        struct LitOrderLAHeapLt {  // sort according to number of occurrences of complement!
            ...
            LitOrderLAHeapLt(CoprocessorData& _data, bool _useComplements)
                : data(_data)
    ...
    public:
        LiteralAddition(CP3Config& _config, Riss::ClauseAllocator& _ca, Riss::ThreadController& _controller, CoprocessorData& _data,
