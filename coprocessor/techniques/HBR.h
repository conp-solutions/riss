...
namespace Coprocessor {
     ...
     */
    class HyperBinaryResolution : public Technique<HyperBinaryResolution> {
        ...
        public:
            LitPair(const Lit& a, const Lit& b)
                : x(a <= b ? a : b)
                , y(a > b ? a : b) {
            }
            LitPair()
    ...
    public:
        HyperBinaryResolution(CP3Config& _config, Riss::ClauseAllocator& _ca, Riss::ThreadController& _controller, CoprocessorData& _data,
